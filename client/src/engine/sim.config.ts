 ...
 * players.ts / enemies.ts); drops are slated for content/drops.ts in Stage F. What
 * remains here is the wave-director cadence and the projectile/pickup padding.
 *
