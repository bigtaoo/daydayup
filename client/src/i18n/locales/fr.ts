...
export const fr: Translations<typeof en> = {
  ...
  forge: {
    ...
    noneStarterPair: '(aucune → {weapons})',
  ...
  store: {
    ...
    pickOne: 'Touchez un article pour l’acheter. Les prix viennent du serveur.',
    empty: 'Rien n’est en vente pour le moment.',
    row: '{item}   {price}',
    rowOwned: '{item}   POSSÉDÉ',
    pagePrev: '‹ PAGE',
    pageNext: 'PAGE ›',
    pageLabel: 'Page {current}/{total}',
    purchasing: 'Achat de {item} — en attente du paiement…',
    purchased: '{item} est à vous. C’est déjà dans la forge.',
    purchasedNoRefresh: '{item} est à vous. L’objet apparaîtra dans la forge à votre prochaine connexion.',
    alreadyOwned: 'Vous possédez déjà {item}.',
    busy: 'Une chose à la fois — la requête précédente est encore en cours.',
    loginRequired: 'Connectez-vous d’abord. Les achats sont liés à votre compte, pas à cet appareil.',
    unavailableHere: 'Les achats ne sont pas disponibles dans cette version du jeu.',
    notConfigured: 'Achats indisponibles pour le moment : aucun prestataire de paiement n’est configuré dans cette version. Rien n’a été débité.',
    orderFailed: 'Impossible de lancer l’achat. Rien n’a été débité.',
    paymentFailed: 'Le paiement n’a pas abouti. Rien n’a été débité.',
    pending: 'Paiement toujours en attente. S’il aboutit, l’objet apparaîtra à votre prochaine connexion.',
    listFailed: 'Impossible de charger la boutique. Vérifiez votre connexion et réessayez.',
  },
  hud: {
  ...
  toast: {
    ...
    replaySaved: 'Replay enregistré : {name}',
    replayNoRun: 'Rien à enregistrer pour le moment',
    replayUnsupported: 'Cet appareil ne peut pas enregistrer de fichiers',
  },
  compareCard: {
    damage: 'Dégâts',
    type: 'Type',
  ...
  card: {
    ...
    capacitor: { name: 'Condensateur', desc: '+{value} d’énergie max' },
  },
  buff: {
    ...
    cell_up: { name: 'Énergie maximale augmentée' },
  },
  material: {
