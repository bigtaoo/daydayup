...
export const zh: Translations<typeof en> = {
  ...
  store: {
    ...
    pageNext: '下一页 ›',
    pageLabel: '第 {current}/{total} 页',
    purchasing: '正在购买 {item} —— 等待支付结果…',
    purchased: '{item} 已到账，现在就在锻造场里。',
    purchasedNoRefresh: '{item} 已到账，下次登录时会出现在锻造场里。',
    alreadyOwned: '你已经拥有 {item}。',
    busy: '上一个请求还没结束，请稍候。',
    loginRequired: '请先登录。购买绑定的是账号，不是这台设备。',
    unavailableHere: '此版本不提供购买功能。',
    notConfigured: '暂时无法购买：本版本尚未接入支付渠道。没有产生任何扣款。',
    orderFailed: '下单失败，没有产生任何扣款。',
    paymentFailed: '支付未完成，没有产生任何扣款。',
    pending: '仍在等待支付结果。若支付成功，下次登录时物品会出现。',
    listFailed: '商店载入失败，请检查网络后重试。',
  },
  hud: {
