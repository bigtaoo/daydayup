...
export const ru: Translations<typeof en> = {
  ...
  forge: {
    ...
    storeLine: 'Магазин: {items}  — [B] открыть магазин',
    storeButton: 'МАГАЗИН',
  ...
  store: {
    ...
    pickOne: 'Нажмите на товар, чтобы купить его. Цены задаёт сервер.',
    empty: 'Сейчас ничего не продаётся.',
    row: '{item}   {price}',
    rowOwned: '{item}   В НАЛИЧИИ',
    pagePrev: '‹ СТРАНИЦА',
    pageNext: 'СТРАНИЦА ›',
    pageLabel: 'Страница {current}/{total}',
    purchasing: 'Покупаем {item} — ждём подтверждения оплаты…',
    purchased: '{item} — ваше. Уже в кузнице.',
    purchasedNoRefresh: '{item} — ваше. Появится в кузнице при следующем входе.',
    alreadyOwned: 'У вас уже есть {item}.',
    busy: 'По одному запросу за раз — предыдущий ещё выполняется.',
    loginRequired: 'Сначала войдите в аккаунт. Покупки привязаны к аккаунту, а не к устройству.',
    unavailableHere: 'В этой версии игры покупки недоступны.',
    notConfigured: 'Покупки сейчас недоступны: в этой сборке не настроен платёжный провайдер. Ничего не списано.',
    orderFailed: 'Не удалось начать покупку. Ничего не списано.',
    paymentFailed: 'Оплата не прошла. Ничего не списано.',
    pending: 'Оплата ещё обрабатывается. Если она пройдёт, предмет появится при следующем входе.',
    listFailed: 'Не удалось загрузить магазин. Проверьте соединение и попробуйте снова.',
  },
  hud: {
