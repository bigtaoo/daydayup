...
export const it: Translations<typeof en> = {
  ...
  settings: {
    ...
    quality: 'QUALITÀ: {mode}',
    qualityAuto: 'AUTO',
    qualityHigh: 'ALTA',
    qualityLow: 'BASSA',
    qualityAutoLow: 'AUTO (BASSA)',
    back: 'INDIETRO',
  },
  forge: {
  ...
  store: {
    title: 'NEGOZIO',
    back: 'FUCINA',
    loading: 'Caricamento del negozio…',
    pickOne: 'Tocca un articolo per acquistarlo. I prezzi arrivano dal server.',
    empty: 'Al momento non c’è nulla in vendita.',
    row: '{item}   {price}',
    rowOwned: '{item}   POSSEDUTO',
    pagePrev: '‹ PAGINA',
    pageNext: 'PAGINA ›',
    pageLabel: 'Pagina {current}/{total}',
    purchasing: 'Acquisto di {item} — in attesa del pagamento…',
    purchased: '{item} è tuo. Ora si trova nella fucina.',
    purchasedNoRefresh: '{item} è tuo. Comparirà nella fucina al prossimo accesso.',
    alreadyOwned: 'Possiedi già {item}.',
    busy: 'Una cosa alla volta: la richiesta precedente è ancora in corso.',
    loginRequired: 'Accedi prima. Gli acquisti appartengono al tuo account, non a questo dispositivo.',
    unavailableHere: 'Gli acquisti non sono disponibili in questa versione del gioco.',
    notConfigured: 'Acquisti non disponibili al momento: questa versione non ha un fornitore di pagamento configurato. Non è stato addebitato nulla.',
    orderFailed: 'Impossibile avviare l’acquisto. Non è stato addebitato nulla.',
    paymentFailed: 'Il pagamento non è andato a buon fine. Non è stato addebitato nulla.',
    pending: 'Pagamento ancora in attesa. Se andrà a buon fine, l’oggetto comparirà al prossimo accesso.',
    listFailed: 'Impossibile caricare il negozio. Controlla la connessione e riprova.',
  },
  hud: {
  ...
  toast: {
    ...
    replaySaved: 'Replay salvato: {name}',
    replayNoRun: 'Non c’è ancora nulla da salvare',
    replayUnsupported: 'Questo dispositivo non può salvare file',
  },
  compareCard: {
    damage: 'Danno',
    type: 'Tipo',
