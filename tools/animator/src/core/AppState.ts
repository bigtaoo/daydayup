...
export class AppState {
  ...
  // ── Attachment points ─────────────────────────────────────────────────────
  // No hardcoded seed here — the rig's default attachment set (App.ts's
  // DEFAULT_ATTACHMENTS) is the single source of truth, applied once at boot
  // via setAllAttachmentPoints() before anything renders.
