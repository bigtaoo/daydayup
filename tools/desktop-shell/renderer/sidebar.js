(function () {
  ...
  function showBanner(info) {
    var label = info.kind === 'app' ? 'DD Tool has a new version' : 'This tool has a new version — your work was auto-saved';
    bannerEl.innerHTML = '';
  ...
  if (!window.nwShell) {
    listEl.textContent = '(running outside the desktop shell, no nwShell bridge)';
    return;
  }
