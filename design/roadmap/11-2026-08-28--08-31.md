...
`render/rigRecoil.ts` (renamed `rigAttackMotion.ts` on 2026-09-02, when it grew the melee swing)
is a one-shot 0→1→0 envelope (150 ms, 22% kick / 78% settle) layered over
