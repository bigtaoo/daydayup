...
- **`audioPipeline.test.ts`** (12) / **`wechatAudioLoad.test.ts`** (9, 2026-08-28) — the two
  ...
  `readFileSync`'s encoding argument, which had been hiding a real device-only failure.
